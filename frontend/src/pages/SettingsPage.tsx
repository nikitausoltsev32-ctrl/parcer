  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100vh", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px" }}>
        ...
        <div style={{ fontSize: "14.5px", fontWeight: 600, color: G.textPrimary }}>Настройки в разработке</div>
        <div style={{ fontSize: "13px", color: G.textMuted, maxWidth: "320px", lineHeight: "1.5", textAlign: "center" }}>
