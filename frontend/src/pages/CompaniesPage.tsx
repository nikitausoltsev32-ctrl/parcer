...
export default function CompaniesPage() {
  ...
  // ⚡ Bolt: Memoize the derived companies array to prevent recalculating on every re-render
  ...
  // This changes the search string allocation from O(N) to O(1) and prevents re-filtering on hover state changes
